...
const auth = useAuthStore(); const couple = useCoupleStore(); const locations = useLocationStore(); const mapRef = ref<InstanceType<typeof CoupleMapVue> | null>(null)
